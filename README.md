...
5. Run the following command `cd /etc/netplan`, look for any config file something like `*-config.yaml` or `*-net-ctf.yaml`. Then open that file with your text editor. Edit this file and add the following, note that you must change ens33 to be your interface found in the Ethernets section above.
